...
public class MovieHallsServiceTests : IClassFixture<MovieHallsServiceFixture>
{
	...
	public async Task GetById_Should_ThrowNullReferenceException_WhenMovieHallDoesNotExist()
	{
		...
		// Act
		var result = async () => await _fixture.MovieHallsService.GetById(_fixture.GetMovieHallByIdRequest, _fixture.ServerCallContext);
	...
	public async Task Update_Should_ThrowNullReferenceException_WhenMovieHallDoesNotExist()
	{
		...
		// Act
		var result = async () => await _fixture.MovieHallsService.Update(_fixture.UpdateMovieHallRequest, _fixture.ServerCallContext);
	...
	public async Task Delete_Should_ThrowNullReferenceException_WhenMovieHallDoesNotExist()
	{
		...
		// Act
		var result = async () => await _fixture.MovieHallsService.Delete(_fixture.DeleteMovieHallRequest, _fixture.ServerCallContext);
